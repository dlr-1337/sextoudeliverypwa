...
This tracked source document is the reviewer-facing M002 requirement matrix. Use it to verify the M002 customer money flow without reading ignored workflow artifacts. M002 closes the first CASH ordering loop; M003 now provides the downstream merchant-side operation proof, while later milestones still own real PIX/card gateways, billing, production storage and deployment.
...
- **M002-supported / M003 final evidence delivered separately** means M002 creates or displays the foundation, and `docs/m003-requirements-coverage.md` owns the completed merchant-operation evidence.
