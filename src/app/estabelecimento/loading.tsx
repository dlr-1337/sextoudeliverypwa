      ...
      <Container className="space-y-5">
        <div className="rounded-full border border-orange-200/70 bg-white/80 px-4 py-3 shadow-sm shadow-orange-950/5 backdrop-blur">
          <p className="text-sm font-black uppercase tracking-[0.24em] text-orange-950">
            Sextou Delivery · Estabelecimento
          </p>
        </div>
        <FeedbackState
          description="Estamos validando sua sessão e carregando os dados seguros do estabelecimento."
          title="Carregando painel da loja"
          tone="loading"
        />
      </Container>
    </main>
